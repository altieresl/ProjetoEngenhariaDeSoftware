...
<body>
	<div class="container">
		...
		<form action="../controller/C_Exame.php" method="POST" id="alterar">
			...
			<div class="item">
				<p>Diagnóstico: <span class="obrigatorio">*</span></p>
				<div class="divCampo">
					<input type="text" class="form-control campo-obrigatorio" name="diagnostico" id="diagnostico">
				</div>
			</div>
			<div class="right">
	...
	$(document).ready(function()
	{
		...
		$.ajax({
			...
			success: function(res)
			{
				...
				$("#diagnostico").val(res.diagnostico);
